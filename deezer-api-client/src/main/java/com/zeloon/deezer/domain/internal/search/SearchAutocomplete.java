...
public class SearchAutocomplete extends Search<Autocomplete> {
    ...
    public SearchAutocomplete(String text) {
        super(Autocomplete.class, SEARCH_PATH, text);
    }

    public SearchAutocomplete(String text, SearchOrder searchOrder) {
        super(Autocomplete.class, SEARCH_PATH, text, searchOrder);
    }
