...
public class SearchAlbum extends Search<Albums> {
    ...
    public SearchAlbum(String text) {
        super(Albums.class, SEARCH_PATH, text);
    }

    public SearchAlbum(String text, SearchOrder searchOrder) {
        super(Albums.class, SEARCH_PATH, text, searchOrder);
    }
